...
@section('title', $Edit->title.' | Edit Product ')
@section('content')
                            ...
                            {{--    <div class="row">
                                    ...
                                    <div class="col-md-9 d-flex">
                                        <div class="p-2">
                                            ...
                                            <img src="{{ (!$Edit->getFirstMediaUrl('web_'.$localeCode)) ? '/backend/resimyok.jpg': $Edit->getFirstMediaUrl('web_'.$localeCode)}}"
                                                 class="img-fluid mb-2 mt-2" alt="{{$Edit->title }}" style="max-width: 250px">
                                        </div>
                                        ...
                                        <div class="p-2">
                                            ...
                                            <img src="{{ (!$Edit->getFirstMediaUrl('mobil_'.$localeCode )) ? '/backend/resimyok.jpg': $Edit->getFirstMediaUrl('mobil_'.$localeCode)}}"
                                                 class="img-fluid mb-2 mt-2" alt="{{$Edit->title }}" style="max-width: 250px">
                                        </div>
                                ...
                                <div class="card-header mb-2">
                                    <h4 class="card-title">
                                        ...
                                        Seo Information - {{ $properties['native'] }}
                                    </h4>
                                </div>
                                ...
                                <div class="row d-flex justify-content-center align-items-center" style="border: 1px solid #eee">
                                    ...
                                    <div class="col-md-6">
                                        <h3>
                                            {{$Edit->title }}
                                            <span class="badge {{ (strlen($Edit->title) <= 250 && strlen($Edit->title) >= 60 ) ? "bg-success" : "bg-danger" }}">
                                                {{strlen($Edit->title). " /250"}}
                                            </span>
                                        </h3>
                                        <p>
                                            {{$Edit->seo2 }}
                                            <span class="badge {{ (strlen($Edit->seo2) <= 250 && strlen($Edit->seo2) >= 150 ) ? "bg-success" : "bg-danger" }}">
                                                {{strlen($Edit->seo2). "/250"}}
                                            </span>
                                        </p>
                                    </div>
                                </div>
