...
@section('title', $Edit->title.' | Edit Gallery Category')
@section('content')
    {{Form::model($Edit, ["route" => ["gallery-categories.update", $Edit->id],'enctype' => 'multipart/form-data'])}}
    @method('PUT')
    <div class="row">
                    ...
                    <div class="tab-content">
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            ...
                            <div class="tab-pane @if ($loop->first) show active @endif" id="{{ $localeCode }}">
                                ...
                                <x-form-inputtext label="Category Title" name="title:{{ $localeCode }}"/>
                                <x-form-textarea label="Short Desc" name="short:{{ $localeCode }}"/>
                                ...
                                <x-form-inputtext label="Seo Title" name="seo1:{{ $localeCode }}"/>
                                <x-form-inputtext label="Seo Desc" name="seo2:{{ $localeCode }}"/>
                                <x-form-inputtext label="Search Words " name="seo3:{{ $localeCode }}"/>
        ...
        <div class="col-12 col-md-3">
            <div class="card">
                ...
                <div class="form-group mb-1 row p-2">
                    <div class="col">
                        <img src="{{ (!$Edit->getFirstMediaUrl('page')) ? '/backend/resimyok.jpg': $Edit->getFirstMediaUrl('page')}}" class="img-fluid mb-2" width="300px" alt="Image">
                    </div>
                </div>
                <div class="p-2">
