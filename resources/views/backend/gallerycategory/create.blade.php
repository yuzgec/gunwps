...
@section('content')
    <div class="col-12 col-md-9">
        <div class="card">
            {{Form::open(['route' => 'gallery-categories.store', 'enctype' => 'multipart/form-data'])}}
            <div class="card-header d-flex justify-content-between">
                <x-add title="Gallery Category"></x-add>
                <div>
                    <x-back></x-back>
                    <x-save></x-save>
                </div>
                ...
                <div class="tab-content">
                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        ...
                        <div class="tab-pane @if ($loop->first) show active @endif" id="{{ $localeCode }}">
                            ...
                            <x-form-inputtext label="Gallery Title" name="title:{{ $localeCode }}"/>
                            ...
                            <x-form-inputtext label="Search Keywords " name="seo3:{{ $localeCode }}"/>
