        ...
        <div class="card">
            ...
            <div class="table-responsive p-2">
                <table class="table table-hover table-striped table-bordered table-center">
                    ...
                    <tr id="page_{{$item->id}}">
                        <td>
                            <img class="avatar me-2" src="{{ (!$item->getFirstMediaUrl('page')) ? '/backend/resimyok.jpg': $item->getFirstMediaUrl('page','small')}}">
                        </td>
                        <td>
                            <div class="font-weight-medium">
                                <a href="{{ route('service.edit', $item->id) }}" title="Edit">{{ $item->title }}</a>
                            </div>
                        </td>
                        <td>
        ...
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between">
                <div>
                    <h4 class="card-title">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        Service Category [{{ $Kategori->count() }}]
                    </h4>
                </div>
                <div>
                    <a class="btn btn-tabler btn-sm" href="{{ route('servicecategory.index') }}" title="Hizmet Ekle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        Categories
                    </a>
                </div>
            ...
            <div class="table-responsive p-2">
                <table class="table table-hover table-striped table-bordered table-center">
                    ...
                    <tr>
                        <th colspan="4">
                            <a class="btn btn-success btn-block btn-sm" href="{{ route('servicecategory.create') }}" title="Yeni Kategori Ekle">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                                Add New Category
                            </a>
                        </th>
                    ...
                    @foreach($Kategori  as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('servicecategory.edit', $item->id) }}" title="Edit">{{ $item->title }}</a>
                            </td>
                            <td class="text-muted">
                                {{ ($item->parent_id == null) ? 'Parent Category' : 'Child category'  }}
                            </td>
                            <td class="d-none d-lg-table-cell">
                                <a data-bs-toggle="modal" data-bs-target="#silmeonayi{{ $item->id }}" class="text-right">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><line x1="4" y1="7" x2="20" y2="7" /><line x1="10" y1="11" x2="10" y2="17" /><line x1="14" y1="11" x2="14" y2="17" /><path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12" /><path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3" /></svg>
