...
@section('title', $Edit->title.' | Edit Brand')
@section('content')
    {{Form::model($Edit, ["route" => ['brand.update', $Edit->id],'enctype' => 'multipart/form-data'])}}
    @method('PUT')
    <div class="row">
                    ...
                    <div class="tab-content">
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            ...
                            <div class="tab-pane @if ($loop->first) show active @endif" id="{{ $localeCode }}">
                                ...
                                <x-form-inputtext label="Brand Name" name="title:{{ $localeCode }}"/>
                        ...
                        <table class="table table-hover table-striped table-bordered table-center">
                            ...
                            @foreach($Edit->getMedia('gallery') as $item)
                                <tr id="gallery_{{$item->id}}">
                                    ...
                                    <td>
                                        <form action="{{route('brand.deleteGaleriDelete', $Edit->id)}}" method="POST">
